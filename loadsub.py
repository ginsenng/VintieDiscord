...
async def on_ready():
    ...
    await bot.change_presence(activity=discord.Game(name="Utilise moi !"))
...
async def help(ctx):
    ...
    embed.add_field(name="**Ajouter une url**",value=f"**Usage :** ``{configs['prefix']}sub url_vinted``",inline=False)
    embed.add_field(name="**Enlever une url**",value=f"**Usage :** ``{configs['prefix']}remove_sub``",inline=False)
    embed.add_field(name="**Changer l'url**",value=f"**Usage :** ``{configs['prefix']}change_url nouvel_url_vinted``",inline=False)
    embed.add_field(name="**Changer la couleur du texte**",value=f"**Usage :** ``{configs['prefix']}change_color_text (YAML/fix)``",inline=False)
    embed.add_field(name="**Changer la couleur de l'embed**",value=f"**Usage :** ``{configs['prefix']}change_color_embed couleur``",inline=False)
